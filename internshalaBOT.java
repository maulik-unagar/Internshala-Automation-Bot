...
public class internshalaTest {
  ...
  public void searchAndApply() throws InterruptedException {
    ...
    // WebElement intern_select =
    // driver.findElement(By.xpath("//*[@id=\"individual_internship_895975\"]/div[1]/div[1]/div[1]/h4[1]/a"));
    // intern_select.click();
    driver.navigate().to(
        "https://internshala.com/internship/detail/webflow-development-work-from-home-job-internship-at-codeacious-technologies-private-limited1587013074");
    driver.navigate().to(
        "https://internshala.com/student/interstitial/application/webflow-development-work-from-home-job-internship-at-codeacious-technologies-private-limited1587013074");
    ...
    try {
      ...
      proceed.click();
    } catch (Exception e) { // if applied then go back to internships page
      WebElement internships = driver.findElement(By.id("internships_new_superscript"));
      internships.click();
    }
  }
